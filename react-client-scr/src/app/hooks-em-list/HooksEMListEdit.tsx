...
type HooksEMListEditAssociationOptions = {
...
type HooksEMListEditLocalStore = HooksEMListEditAssociationOptions & {
  updated: boolean;
  globalErrors: string[];
...
const getAssociationOptions = (
  mainStore: MainStore
): HooksEMListEditAssociationOptions => {
  const { getAttributePermission } = mainStore.security;
  const associationOptions: HooksEMListEditAssociationOptions = {};
...
const HooksEMListEdit = (props: Props) => {
  ...
  const store: HooksEMListEditLocalStore = useLocalStore(() => ({
    // Association options
...
export default HooksEMListEdit;
